...
#Create a file with different number or letter patterns
...
#Databases of names are freely available on the internet
...
#What is the percentage of accounts that would have been compromised?
